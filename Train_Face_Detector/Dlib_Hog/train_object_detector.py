...
faces_folder_train = sys.argv[1]
faces_folder_test = sys.argv[2]
...
training_xml_path = os.path.join(faces_folder_train, "faces/training.xml")
testing_xml_path = os.path.join(faces_folder_test, "faces/testing.xml")
...
faces_folder_validate = '/home/prabodh/personal_space/How_I_Am_Learning_ML/Dataset/Dlib_Dataset/validation'
for f in glob.glob(os.path.join(faces_folder_validate, "*.jpg")):
